...
**Programa**:
   ...
   3. Regresión Logística y nomogramas
   4  Árboles de decisión: clasificación y regresión (CART), Bagged y Random Forest
   5. Métodos para tratar datos desbalanceados
